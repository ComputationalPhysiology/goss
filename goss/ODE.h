...
namespace goss {
  ...
  class ODE 
  {
    public:
      ...
      virtual void getParameters(goss::DoubleVector*) const;
      virtual std::string getStateName(int idx) const;
      virtual std::string getParameterName(int idx) const;
      virtual void getIC(goss::DoubleVector *res) const = 0;
      virtual void getDefaultInitialCondition(goss::DoubleVector *res) const
      {

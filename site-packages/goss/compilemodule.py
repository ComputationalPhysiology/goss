...
%import(module="goss.cpp") "goss/LinearizedODE.h"
...
def jit(ode, **options):
    ...
    module_name = "goss_compiled_module_{0}_{1}".format(\
        oderepr.ode.name, hashlib.md5(repr(cpp_code) + \
...
def configure_instant():
    ...
    (instant_kwargs['include_dirs'],
     ...
     instant_kwargs['library_dirs']) = instant.header_and_libs_from_pkgconfig("goss")

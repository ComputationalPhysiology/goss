...
class GossCodeGenerator(CppCodeGenerator):
    ...
    def default_parameters():
        ...
        return ParameterDict(state_repr=state_repr.copy(),
                             ...
                             generate_jacobian = Param(\
                                 True, description="Generate analytic jacobian "\
                                 "when integrating."),\
                             )
    ...
    def _eval_linearized_code(self):
        ...
        lin = linearized_derivatives(self.ode, result_name="linear_values", \
                                     params=self.params.code)
        ...
        body = self.wrap_body_with_function_prototype(\
            body, "linear_derivatives", "const double* states, double time, "\
    ...
    def _jacobian_code(self):
        ...
        # FIXME: Add factorized jacobian and forwarf backward subst code...
        return 

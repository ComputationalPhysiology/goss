...
if (GOSS_ENABLE_PYTHON)
  ...
  if (PYTHONINTERP_FOUND AND PYTHONLIBS_FOUND)
    ...
    if(NUMPY_VERSION VERSION_GREATER 1.6.2)
      set(GOSS_PYTHON_DEFINITIONS ${GOSS_PYTHON_DEFINITIONS} -DNPY_NO_DEPRECATED_API=NPY_${NUMPY_VERSION_MAJOR}_${NUMPY_VERSION_MINOR}_API_VERSION)
    endif()
...
set(GOSS_BOOST_COMPONENTS system thread program_options)
...
list(APPEND GOSS_TARGET_LINK_LIBRARIES_DIRS ${Boost_LIBRARY_DIRS})
